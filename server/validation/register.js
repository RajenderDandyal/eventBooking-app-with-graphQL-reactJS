...
module.exports = function validateRegisterInput(data) {
  ...
  data.longitude = isEmpty(data.longitude) ? "" : data.longitude; // checking if input is empty then set it to ""(empty string)
  data.latitude = isEmpty(data.latitude) ? "" : data.latitude; // checking if input is empty then set it to ""(empty string)
  data.company = isEmpty(data.company) ? "" : data.company; // checking if input is empty then set it to ""(empty string)
